...
Lo studente ha richiesto la seguente tipologia di assegnazione: **`r domanda`**.
...
L'assegnazione é per la destinazione: **`r uni`**, **`r nazione`**, 
...
tbl <- 
  ...
  select(choice_number, sede_ospitante, language_requirement, level_requirement, isced_requirement)
